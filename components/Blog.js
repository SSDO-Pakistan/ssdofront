...
const Blog = ({ Blogs }) => {
  return (
    <div className="col-md-8">
      <div
        className="block-area border bg-light-black"
        style={{ backgroundColor: "#f8f9fa", padding: "20px 20px 10px 20px" }}
      >
        ...
        <div className="border-bottom-last-0 first-pt-0 ">
          {Blogs.data.map((blog) => {
            return (
              <article className="card card-full hover-a py-4" key={blog.id}>
                <div className="row">
