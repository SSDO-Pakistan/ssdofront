            ...
            <div class="row mt-5 mb-5" style={{ justifyContent: "center" }}>
                    ...
                    <div className="card  d-flex align-items-center rgba-black-strong py-5 px-4" style={{ width: "22rem", height: "18rem", backgroundColor: "#F2BF5E", justifyContent: "center" }}>
                        <div className="card-body">
                            <div style={{ marginBottom: "20px", paddingTop: "30px" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-binoculars" viewBox="0 0 16 16">
                ...
                <div class="col-sm-4 mb-3">
                    <div className="card d-flex align-items-center rgba-black-strong py-5 px-4" style={{ width: "22rem", height: "18rem", backgroundColor: "#FF6161", justifyContent: "center" }}>
                        <div className="card-body">
                            <div style={{ marginBottom: "20px", paddingTop: "30px", paddingLeft: "90px" }}>
                ...
                <div class="col-sm-4 mb-3">
                    <div className="card d-flex align-items-center rgba-black-strong py-5 px-4" style={{ width: "22rem", height: "18rem", backgroundColor: "#213E8C", justifyContent: "center" }}>
                        <div className="card-body">
                            <div style={{ marginBottom: "20px", paddingTop: "30px", paddingLeft: "100px" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-chat-square-heart-fill" viewBox="0 0 16 16">
                    ...
                    <div className="card d-flex align-items-center rgba-black-strong py-5 px-4" style={{ width: "22rem", height: "18rem", backgroundColor: "#35C68B", justifyContent: "center" }}>
                        <div className="card-body">
                            <div style={{ marginBottom: "20px", paddingTop: "20px", paddingLeft: "100px" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-rocket-takeoff-fill" viewBox="0 0 16 16">
                ...
                <div class="col-sm-4 mb-3">
                    <div className="card d-flex align-items-center rgba-black-strong py-5 px-4" style={{ width: "22rem", height: "18rem", backgroundColor: "#F2BF5E", justifyContent: "center" }}>
                        <div className="card-body">
                            <div style={{ marginBottom: "20px", paddingTop: "20px", paddingLeft: "65px" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-person-fill-add" viewBox="0 0 16 16">
                ...
                <div class="col-sm-4 mb-3">
                    ...
                    <div className="card d-flex align-items-center rgba-black-strong py-5 px-4" style={{ width: "22rem", height: "18rem", backgroundColor: "#FF6161", justifyContent: "center" }}>
                        <div className="card-body">
                            <div style={{ marginBottom: "20px", paddingTop: "20px", paddingLeft: "105px" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-diagram-3" viewBox="0 0 16 16">
                ...
                <div class="col-sm-4 mb-3">
                    <div className="card d-flex align-items-center rgba-black-strong py-5 px-4" style={{ width: "22rem", height: "18rem", backgroundColor: "#C84869", justifyContent: "center" }}>
                        <div className="card-body">
                            <div style={{ marginBottom: "20px", paddingTop: "20px", paddingLeft: "105px" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-person-bounding-box" viewBox="0 0 16 16">
                ...
                <div class="col-sm-4 mb-3">
                    <div className="card d-flex align-items-center rgba-black-strong py-5 px-4" style={{ width: "22rem", height: "18rem", backgroundColor: "#3A57A6", justifyContent: "center" }}>
                        <div className="card-body">
                            <div style={{ marginBottom: "20px", paddingTop: "10px", paddingLeft: "65px" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="white" class="bi bi-eye" viewBox="0 0 16 16">
